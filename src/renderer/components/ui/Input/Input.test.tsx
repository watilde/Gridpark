...
describe('Input Component', () => {
  ...
  it('prioritizes error message over other helper text', () => {
    render(
      <Input error="Error message" success="Success message" helperText="Regular helper text" />
    );
  ...
  it('displays success message when no error is present', () => {
    render(<Input success="Success message" helperText="Regular helper text" />);
  ...
  it('maintains form control structure with label and helper text', () => {
    render(<Input label="Form Label" helperText="Helper text" error="" />);
