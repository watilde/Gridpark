...
export const Default: Story = {
  render: () => (
    <ModalDemo modalProps={{
      ...
      children: (
        <Typography>
          This is a basic modal with default styling. It includes a header with title,
          scrollable content area, and proper focus management.
        </Typography>
      ),
    }} />
  ),
    ...
    <ModalDemo modalProps={{
      ...
      children: (
        <Typography>
          ...
          All dependent formulas will show #NAME? errors.
        </Typography>
      ),
      actions: (
        <>
          <Button variant="soft" startIcon={<Cancel />}>Cancel</Button>
          <Button color="danger" startIcon={<Delete />}>Delete Function</Button>
        </>
      ),
    }} />
  ),
  ...
  render: () => (
    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
      ...
      <ModalDemo modalProps={{
        ...
        size: 'xl',
        children: <Typography>Extra large modal for detailed views and advanced workflows.</Typography>,
      }} />
    </div>
  ),
};
    ...
    <ModalDemo modalProps={{
      ...
      children: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          />
          <div style={{ height: '200px', border: '1px solid #ccc', borderRadius: '8px', padding: '12px' }}>
            <Typography level="body-sm" sx={{ mb: 1 }}>Function Implementation:</Typography>
            <Typography component="pre" sx={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '14px' }}>
  ...
  return roi / period;  // Annual ROI
      ...
      actions: (
        <>
          ...
          <Button variant="outlined" startIcon={<Code />}>Test Function</Button>
      ...
      children: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <Card
            variant="soft"
            title="⚡ Rate Limiting"
            subtitle="API usage protection"
          >
            <Typography level="body-sm">
              Requests will be automatically throttled to respect API limits.
    ...
    <ModalDemo modalProps={{
      ...
      children: (
        <div style={{ textAlign: 'center', padding: '20px' }}>
          <Typography>
            Importing Excel file and converting formulas...
          </Typography>
    ...
    <ModalDemo modalProps={{
      ...
      children: (
        <div style={{ textAlign: 'center' }}>
          ...
          <Card variant="soft">
            <Typography level="body-sm">
              💡 <strong>Tip:</strong> Use <code>=GRIDPARK.CALCULATE_ROI(D2, E2, 12)</code> to call your function.
            </Typography>
          </Card>
        </div>
      ),
