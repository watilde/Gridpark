...
const useGraffitiBackground = (containerRef: React.RefObject<HTMLDivElement>) => {
  useEffect(() => {
    ...
    baseShapes.forEach(([shape, x, y, size]) => createGraffitiShape(container, shape, x, y, size));
...
const useCrazyAnimations = () => {
  useEffect(() => {
    const titleNodes = Array.from(document.querySelectorAll<HTMLElement>('.feature-card h3'));
...
const useParallaxSpray = () => {
  useEffect(() => {
    const handleScroll = () => {
      ...
      document.querySelectorAll<HTMLElement>('.hero-graffiti, .cta-spray').forEach(element => {
        ...
        <main>
            ...
            <div className="features-grid">
              <div className="feature-card">
                <div className="feature-icon">
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    ...
                    />
                    <path
                      d="M25,25 L35,25 M25,35 L45,35 M25,45 L40,45 M25,55 L50,55"
                      stroke="#d500f9"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
              ...
              <div className="feature-card">
                <div className="feature-icon">
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    ...
                    <path
                      d="M20,40 Q40,15 60,40 Q40,65 20,40"
                      fill="none"
                      stroke="#76ff03"
                      strokeWidth="4"
                    />
              ...
              <div className="feature-card">
                <div className="feature-icon">
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    ...
                    <path
                      d="M40,10 L40,25 M40,55 L40,70 M10,40 L25,40 M55,40 L70,40"
                      stroke="#e63946"
                      strokeWidth="4"
                      strokeLinecap="round"
                    />
              ...
              <div className="feature-card">
                <div className="feature-icon">
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    <path
                      d="M40,15 L50,25 L60,20 L55,35 L65,45 L50,50 L55,65 L40,55 L25,65 L30,50 L15,45 L25,35 L20,20 L30,25 Z"
                      fill="none"
                      stroke="#ffea00"
                      strokeWidth="4"
                    />
              ...
              <div className="feature-card">
                ...
                <div className="feature-card-content">
                  ...
                  <p>
                    Gridpark is 100% open source. Every feature, every extension point, every
                    theme—open to inspect, fork, remix, and improve. The spreadsheet becomes not
                    just a tool but a creative playground for the community.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="philosophy-container">
              ...
              <div className="philosophy-block vision-block">
                ...
                <div className="block-content">
                  ...
                  <p className="description">
                    A world where working with data sparks creativity and joy, not just efficiency.
                    Where spreadsheets become canvases for expression, experimentation becomes
                    natural, and every data interaction feels like landing a perfect trick.
                  </p>
                </div>
                <svg className="block-graffiti" viewBox="0 0 200 200">
                ...
                <div className="block-content">
                  <div className="values-grid">
                    <div className="value-item">
                      ...
                      <p>
                        Powerful tools should be safe by default. Every feature is built within
                        protective boundaries, ensuring you can experiment freely without system
                        risk.
                      </p>
                    </div>
                    <div className="value-item">
                      ...
                      <p>
                        Data exploration should be engaging, experimental, and fun while remaining
                        genuinely useful.
                      </p>
                    </div>
                    <div className="value-item">
                      ...
                      <p>
                        Everyone has a unique way of thinking about data. Our tools amplify personal
                        creativity within predictable boundaries.
                      </p>
                    </div>
                    <div className="value-item">
                      <h3>
                      ...
                      <p>
                        The best tools bend to your will while keeping you safe. Everything is
                        customizable and extensible within our protected environment.
                      </p>
                    </div>
                    <div className="value-item">
                      <h3>
                      ...
                      <p>
                        Innovation builds on what people already know. We provide reasonable
                    ...
                    <div className="value-item">
                      ...
                      <p>
                        Your data belongs on your machine. We build desktop-first experiences that
                        work offline and keep you in complete control.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section className="cta" id="download">
            <div className="cta-content">
              ...
              <p className="cta-description">DΛ雲WN爐LOAD🛣️ﾀﾞｳN露-ﾛｰ度$DΛWN炉ADﾄﾞ</p>
              <div className="cta-buttons">
                <a
                  className="btn-download btn-glow"
                  href="https://github.com/watilde/Gridpark/releases"
                  target="_blank"
                >
                  <svg
                    width="24"
...
const createGraffitiShape = (
  ...
  if (shape === 'circle') {
    ...
    element.setAttribute('transform', `rotate(${Math.random() * 30 - 15} ${size} ${size})`);
